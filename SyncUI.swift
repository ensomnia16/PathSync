...
private let translations: [String: (zh: String, en: String)] = [
    ...
    "conflictPolicyHint": ("默认自动保留两个版本；处理前备份原件。", "By default, both versions are kept and originals are backed up first."),
    ...
    "directionHintAuto": ("发现不同版本时自动保留两份。", "Differing versions are kept automatically."),
