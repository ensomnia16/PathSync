...
swiftc -target "$architecture-apple-macosx13.0" -parse-as-library -O \
    -o "$app/Contents/MacOS/ResearchSync" "$source_dir/ResearchSync.swift" "$source_dir/SyncHistory.swift" "$source_dir/HistoryPage.swift" "$source_dir/SyncUI.swift" "$source_dir/NativeUI.swift"
